...
/* Q2 Signals */
#define ENCODER_G2_PORT		PORTA
#define ENCODER_G2_PIN		PINA
#define ENCODER_G2_DDR		DDRA
...
#define ENCODER_1Q1_MASK	(1<<0)

#define ENCODER_1Q2_PORT	PORTA
#define ENCODER_1Q2_PIN		PINA
#define ENCODER_1Q2_DDR		DDRA
...
#define ENCODER_2Q2_PORT	PORTA
#define ENCODER_2Q2_PIN		PINA
#define ENCODER_2Q2_DDR		DDRA
...
#define ENCODER_3Q1_MASK	(1<<2)

#define ENCODER_3Q2_PORT	PORTA
#define ENCODER_3Q2_PIN		PINA
#define ENCODER_3Q2_DDR		DDRA
...
#define ENCODER_4Q1_MASK	(1<<3)

#define ENCODER_4Q2_PORT	PORTA
#define ENCODER_4Q2_PIN		PINA
#define ENCODER_4Q2_DDR		DDRA
...
#define ENCODER_5Q2_PORT	PORTA
#define ENCODER_5Q2_PIN		PINA
#define ENCODER_5Q2_DDR		DDRA
...
// Get from either Encoders or PotSample based on Configuration:
