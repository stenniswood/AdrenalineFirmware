...
const char MSG_16[] PROGMEM = "\tspeed v300 w999.5 x200 y450 z607 - Move the motors at specified speed (PID control).\r\n";
const char MSG_17[] PROGMEM = "\thome                 - move all motors until near limit switch is triggered.\r\n";
const char MSG_18[] PROGMEM = "\tmeasure travel (all v w x y z) - measures the counts until far limit switch is triggered.\r\n";
const char MSG_19[] PROGMEM = "\tstop                 - stop all motors.\r\n";
const char MSG_20[] PROGMEM = "\r\n--Press Return--\r\n";
// 22 lines
...
const char MSG_29[] PROGMEM = "\r\n2 WHEELED ROBOT COMMANDS:  v and w axes can be designated for a 2 wheel differential robot.\r\n";
const char MSG_30[] PROGMEM = "\tset wheel separation [number] - the distance (in selected unit) between the left & right wheels.\r\n";
...
const char MSG_34[] PROGMEM = "\tspin [number] degrees - this instructs it to spin in place ending up facing a new direction.\r\n";
const char MSG_35[] PROGMEM = "\tforward [number]     - move robot forward __ number of units (whatever is selected)\r\n";
const char MSG_36[] PROGMEM = "\tbackward [number]    - move robot forward __ number of units (whatever is selected)\r\n";
...
PGM_P const help_text_table[] PROGMEM = 
{
	...
	MSG_11, MSG_12, MSG_13, MSG_14, MSG_15, MSG_15a, MSG_15b, MSG_15c, MSG_16, MSG_17, MSG_18, MSG_19, MSG_20, 
	MSG_21, MSG_22, MSG_23, MSG_24, MSG_25, MSG_26, MSG_27, MSG_28, MSG_29, MSG_30,
	MSG_31, MSG_32, MSG_33, MSG_34, MSG_35, MSG_36, MSG_37, MSG_38, MSG_39, MSG_40,
...
const char LIST_6[] PROGMEM = "set wheel separation, set wheel diameter, set counts_per_rev, ";
