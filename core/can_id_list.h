...
#define ID_INSTANCE_RESTART				0xFC26	// All nodes to clear their "Confirmed" Instance status.
												// a passcode 0x1234 inside the message is required!
...
#define ID_SYSTEM_CONFIGURE_REPORT		0xFC27		// Reply to Request from ID_SYSTEM_CONFIGURE data[0]==0x10
...
const byte Adrenaline_Developer		= 0x0A;
