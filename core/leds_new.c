...
{
  if (mHiNibble) {
	  if ((result & 0x80)>0)  protected_led_on(4);  else protected_led_off(4);
	  if ((result & 0x40)>0)  protected_led_on(3);  else protected_led_off(3);
	  if ((result & 0x20)>0)  protected_led_on(2);  else protected_led_off(2);
	  if ((result & 0x10)>0)  protected_led_on(1);  else protected_led_off(1);
  } else {
	  if ((result & 0x08)>0)  protected_led_on(4);  else protected_led_off(4);
	  if ((result & 0x04)>0)  protected_led_on(3);  else protected_led_off(3);
	  if ((result & 0x02)>0)  protected_led_on(2);  else protected_led_off(2);
	  if ((result & 0x01)>0)  protected_led_on(1);  else protected_led_off(1);
  }
}
