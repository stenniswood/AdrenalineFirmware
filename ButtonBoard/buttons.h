...
extern byte NumberKeysPressed;
extern char keys_down[NUM_ROWS];
...
//#define one_second 400000	// approximately
#define CHARGE_TIME   300   // Time constant is 10n * 1k = 10us   
// Clock runs at 16Mhz => 62.5ns per instruction.  
// 10us = 10000ns / 62.5ns = 160 instructions.
// probably decrement, compare, jmp in the loop.  so divide by 3
// 160 / 3 = 53
