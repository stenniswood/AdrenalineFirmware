...
#define LED_1		0
#define LED_1_DDR	DDRF				/* a 1 bit ==> output */
#define LED_1_PORT  PORTF				

#define LED_2		1
#define LED_2_DDR	DDRF
#define LED_2_PORT  PORTF

#define LED_3		2
#define LED_3_DDR	DDRF
#define LED_3_PORT  PORTF

#define LED_4		3
#define LED_4_DDR	DDRF
#define LED_4_PORT  PORTF
